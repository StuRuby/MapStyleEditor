        ...
        <div className='maputnik-toolbar'>
            <div className='maputnik-toolbar__inner'>
                ...
                <div className='maputnik-toolbar__actions'>
                    <ToolbarAction wdKey='nav:open' onClick={props.toggleModalOpen.bind(null, 'open')}  >
                        <MdOpenInBrowser />
                        <IconText>Open</IconText>
                    </ToolbarAction>
                    <ToolbarAction wdKey='nav:export' onClick={props.toggleModalOpen.bind(null, 'export')}  >
                        <MdFileDownload />
                        <IconText>Export</IconText>
                    </ToolbarAction>
                    <ToolbarAction wdKey='nav:sources' onClick={props.toggleModalOpen.bind(null, 'sources')} >
                        <MdLayers />
                        <IconText>Data Sources</IconText>
                    </ToolbarAction>
                    <ToolbarAction wdKey='nav:settings' onClick={props.toggleModalOpen.bind(null, 'settings')} >
                        <MdSettings />
