...
class LayerListContainer extends Component {
    ...
    groupLayers() {
        ...
        for (let i = 0; i < layers.length; i++) {
            ...
            if (
                previousLayer &&
				this.layerPrefix(previousLayer.id) ===
					this.layerPrefix(currentLayer.id)
            ) {
    ...
    setListItems() {
        ...
        groups.forEach(layers => {
                ...
                const group = (
                    <LayerListGroup
                        ...
                        isActive={
							...
							idx === props.selectedLayerIndex
                        }
                        onActiveToggle={this.toggleLayerGroup.bind(
                            this,
                            groupPrefix,
                            idx
                        )}
            ...
            layers.forEach((layer, idxInGroup) => {
                const groupIdx = this.findClosestCommonPrefix(
                    props.layers,
                    idx
                );
